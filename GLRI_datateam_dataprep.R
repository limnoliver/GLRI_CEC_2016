...
write.csv(owc, 'usgs_owc_2016.csv')
write.csv(owc_pcodes, 'usgs_owc_pcodes_2016.csv')
write.csv(owc_sites, 'usgs_owc_sites_2016.csv')
...
write.csv(pesticide, 'usgs_pesticide_2016.csv')
write.csv(pesticide_pcodes, 'usgs_pesticide_pcodes_2016.csv')
write.csv(pesticide_sites, 'usgs_pesticide_sites_2016.csv')
